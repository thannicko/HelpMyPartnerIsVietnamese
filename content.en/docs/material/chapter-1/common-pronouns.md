...
{{< badge value="Example" >}} We mentioned before that pronouns can change depend on who you're talking to. Let's look at an example:
...
```mermaid
graph TD
A[You see a person on the street]
    A --> C{Could they be your grandparents in age?}
    C -->|Yes| D['Ông/Bà' for them, 'Con' for you]
    C -->|No| E{Could they be your aunt or uncle in age?}
